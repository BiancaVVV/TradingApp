...
import com.bianca.trading.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setPriceChangePercentage24h(marketData.get("price_change2_24").get("usd").asDouble());
    ...
    @Override
    public String getTop500CoinsByMarketCapRank() throws Exception {
